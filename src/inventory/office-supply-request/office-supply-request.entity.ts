...
@Entity({ name: 'office_supply_request' })
export class OfficeSupplyRequestEntity extends BaseEntity {
    ...
    comment: string;
    @ManyToOne(type => MasterEntity, master => master.officeSupplyRequest, { onDelete: 'CASCADE', onUpdate: 'CASCADE' })
