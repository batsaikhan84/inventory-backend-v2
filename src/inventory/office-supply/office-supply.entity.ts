...
@Entity({ name: 'office_supply' })
export class OfficeSupplyEntity extends BaseEntity {
    ...
    updated_on: Date;
    @ManyToOne(type => MasterEntity, master => master.officeSupply, { onDelete: 'CASCADE', onUpdate: 'CASCADE' })
