...
@Entity({ name: 'breakroom_request' })
export class BreakroomRequestEntity extends BaseEntity {
    ...
    comment: string;
    @ManyToOne(type => MasterEntity, master => master.breakroomRequest, { onDelete: 'CASCADE', onUpdate: 'CASCADE' })
