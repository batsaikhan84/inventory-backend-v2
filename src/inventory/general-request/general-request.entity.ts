...
@Entity({ name: 'general_request' })
export class GeneralRequestEntity extends BaseEntity {
    ...
    comment: string;
    @ManyToOne(type => MasterEntity, master => master.generalRequest, { onDelete: 'CASCADE', onUpdate: 'CASCADE' })
